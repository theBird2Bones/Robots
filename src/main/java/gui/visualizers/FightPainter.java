...
public class FightPainter {
  ...
  private void paintOnPanel(Graphics2D g2d, BufferedImage backgroundImage) {
    ...
    g2d.drawImage(backgroundImage, 0, 0, arenaSize.width, arenaSize.height, fightPanel);
  }
  ...
  private void createBackground() {
    ...
    synchronized (this) {
      backgroundImage =
          new BufferedImage(arenaSize.width, arenaSize.height, BufferedImage.TYPE_INT_RGB);
    }
  }
}

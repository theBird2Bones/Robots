...
public class RobotVisualizer {
  ...
  public void paint(Graphics2D g2d) {
    drawRobot(g2d, robotController.getRobotPosition(), robotController.getRobotDirection());
  ...
  private void drawRobot(Graphics2D g, Point2D.Double robotPos, double direction) {
    ...
    AffineTransform t =
        AffineTransform.getRotateInstance(direction, roundRobotPos.x, roundRobotPos.y);
    g.setTransform(t);
